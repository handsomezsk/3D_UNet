...
class ConvTranspode(nn.Module):
    def __init__(self, in_channels, out_channels, k_size=3, stride=2, padding=1, output_padding=1):
        super(ConvTranspode, self).__init__()
...
class DecodeBlock(nn.Module):
    def __init__(self, out_channels, model_depth=4):
        ...
        for depth in range(model_depth - 2, -1, -1):
            ...
            self.deconv = ConvTranspode(in_channels=feat_map_channels * 4, out_channels=feat_map_channels * 4)
