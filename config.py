...
parser.add_argument('--data_path', default = '/content/drive/Shareddrives/课程实验/datasets', help='dataset root path')
parser.add_argument('--pred_path',default = 'output/pred',help='pred path')
parser.add_argument('--save',default='outputs/UNet',help='save path of trained model')
